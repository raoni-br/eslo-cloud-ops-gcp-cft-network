...
module "base_shared_vpc" {
  ...
  serverless_vpc_connector = {
    ip_cidr_range  = "10.1.0.32/28"
    min_throughput = 200
    max_throughput = 400
    access_sas = [
      "service-1031330240347@serverless-robot-prod.iam.gserviceaccount.com",
      "run-backend-service@prj-e2c-p-platform-bb51.iam.gserviceaccount.com"
    ]
  }
}
