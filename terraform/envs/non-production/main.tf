...
module "base_shared_vpc" {
  ...
  serverless_vpc_connector = {
    ip_cidr_range  = "10.1.0.16/28"
    min_throughput = 200
    max_throughput = 300
    access_sas = [
      "service-822911714916@serverless-robot-prod.iam.gserviceaccount.com",
      "run-backend-service@prj-e2c-n-platform-ee5b.iam.gserviceaccount.com"
    ]
  }
}
